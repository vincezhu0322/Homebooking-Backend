...
import com.laioffer.homebooking.exception.StayDeleteException;
import com.laioffer.homebooking.exception.StayNotExistException;
import com.laioffer.homebooking.model.*;
import com.laioffer.homebooking.repository.ReservationRepository;
import com.laioffer.homebooking.repository.StayRepository;
...
import com.laioffer.homebooking.repository.LocationRepository;
...
public class StayService {
    ...
    public Stay findByIdAndHost(Long stayId, String username) throws StayNotExistException {
        ...
        if (stay == null) {
            throw new StayNotExistException("Home doesn't exist");
        }
        return stay;
    }
